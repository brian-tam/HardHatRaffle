    ...
    : describe("Raffle Unit Tests", function () {
          ...
          describe("enterRaffle", function () {
              ...
              it("records players when they enter", async function () {
                  ...
                  // The deployer gonna be the first player of the contract
              ...
              it("doesnt allow entrance when raffle is caluculating", async function () {
                  await raffle.enterRaffle({ value: raffleEntranceFee })
                  // add time
          ...
          describe("checkUpkeep", function () {
              it("returns false if people haven't sent any ETH", async function () {
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
                  // As checkUpkeep not a view function, so need to pass callstatic
                  // to simulate the function all
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("picks a winner, resets the lottery, and sends money", async function () {
                  ...
                  // performUpkeep (mock being chainlink keep)
